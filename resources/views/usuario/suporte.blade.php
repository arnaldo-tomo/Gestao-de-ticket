...
@section('conteudo')
    <title>Gestao de Tickts - Submeter</title>
        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pedir Suporte</li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea name="suporte" class="form-control"></textarea>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="status" value=""
                                            ...
                                            <option disabled value="Ugente">Selecione...</option>
                                            @foreach ($nivel as $todos)
                                                <option value="{{ $todos->nivel }}">{{ $todos->nivel }}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-6 py-4">
                                        <button type="submit" class="btn btn-primary">Pedir Suporte</button>
                                    </div>
