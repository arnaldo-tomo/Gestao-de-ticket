...
@section('conteudo')
    <title>Gestão de Tickts - Pendentes</title>
        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Suporte Pedentes</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                                    ...
                                    <h3 class="fw-extrabold mb-2">{{ $pedente->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card border-0 shadow">
                                <div class="table-responsive">
                                    <table class="table table-striped ">
                                        ...
                                        <tbody>
                                            @foreach ($pedente as $dado)
                                                <tr>
                                                    <td>
                                                        <a class="btn btn-sm btn-primary"
                                                            href="{{ route('editar', $dado->id) }}"><i
                                                                class="fa fa-edit"></i></a>
                                                        <a href="{{ route('apagar', $dado->id) }}"
                                    ...
                                    <div class="col-12 text-center d-flex align-items-center justify-content-center">
                                        <div>
                                            <img class="img-fluid w-50" src="../../assets/img/illustrations/404.svg"
                                                alt="404 not found">
                                            <h1 class="mt-5">Sem Nenhum <span
                                                    class="fw-bolder text-primary">Suporte</span></h1>
                                            <p class="lead my-4">Continuacao de um boom trabalho estas sem senhum suporte
                                                pedente!</p>
