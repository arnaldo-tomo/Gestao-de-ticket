...
@section('conteudo')
<title>Gestao de Tickts - Realizados</title>
    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Suporte Finalizados</li>
            </ol>
        </nav>
    </div>
                                ...
                                <table class="table table-striped ">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th class="border-0">Suporte</th>
                                            <th class="border-0">Urgencia</th>
                                            <th class="border-0">Criado EM</th>
                                            <th class="border-0">Status</th>
                                            <th class="border-0">Concluidas EM</th>


                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($resolvido as $dado)
                                        <tr>
                                            <td>{{ $dado->id }}</td>
                                            <td>{{ $dado->suporte }}</td>
                                            <td>
                                                @if ($dado->status == 'Urgente')
                                                <span class="badge badge-sm bg-danger ms-2 ">{{ $dado->status }}
                                                </span>
                                                @elseif ($dado->status == 'Medio')
                                                <span class="badge badge-sm bg-success ms-2 ">{{ $dado->status }}
                                                </span>
                                                @else
                                                <span class="badge badge-sm bg-info ms-2 ">{{ $dado->status }}
                                                </span>
                                                @endif
                                            ...
                                            @if ($dado->deleted_at == null)
                                            <td>
                                                <a class="badge badge-sm bg-success ms-1 text-gray-800"><i class="fa fa-spinner"></i> Pendente</b>
                                            </td>
                                            @else
                                            <td>
                                                <a class="badge badge-sm bg-warning ms-1 text-gray-800"><i class=" fa fa-check"></i></i> Realizado</button>
                                            </td>
                                            @endif
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 text-center d-flex align-items-center justify-content-center">
                                    <div>
                                        <img class="img-fluid w-50" src="../../assets/img/illustrations/404.svg" alt="404 not found">
                                        <h1 class="mt-5">Nenhum Suporte <span class="fw-bolder text-primary">Finalizado</span></h1>
                                        <p class="lead my-4">Continuacao de um boom trabalho estas sem senhum suporte finalizado!</p>
