        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('AdminUsario') }}">Lista de Funcionarios</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Editar usuario</li>
                </ol>
            </nav>
            {{-- <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h5">Editar Informacao do::</h1>
                        <p class="mb-0">Nos campos a baixo podes.</p>
                    </div>
                    <div>
                        <a href="#" class="btn btn-outline-gray"><i class="far fa-question-circle me-1"></i>
                            Ajuda</a>
                    </div>
                </div> --}}
        </div>
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        <form action="{{ url('actuliazar/' . $usuario->id) }}" method="put">
                            @csrf
                            <div class="row mb-4">

                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-4">
                                        <label for="text">Nome Usuaio</label>
                                        <input type="text" class="form-control" name="name" value="{{ $usuario->name }}" aria-describedby="emailHelp">
                                    </div>
                                    <div class="my-4">
                                        <label for="textarea">Descricao</label>
                                        <textarea class="form-control" value="{{ $usuario->biografia }}" rows="4"></textarea>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" name="departamento" value="{{ $usuario->departamento}}" aria-label="Default select example">
                                        ...
                                        <input type="password" class="form-control" name="password" value="{{ $usuario->password }}" aria-describedby="emailHelp">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" value="{{ $usuario->email }}" aria-describedby="emailHelp">
                                        <label for="email">Confirmar-Password</label>
                                        <input type="text" class="form-control" name="password" value="{{ $usuario->password }}" aria-describedby="emailHelp">
                                    </div>
                                    <button class="btn btn-info btn-sm" type="submit">Atualizar</button>
                                    <a href="{{ route('AdminUsario') }}" button class="btn btn-danger btn-sm" type="reset">Cancelar</a>
                                </div>
