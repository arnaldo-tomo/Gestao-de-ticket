...
@section('conteudo')
    <title>Gestao de ticket - Pedidos</title>
                    ...
                    <a href="{{ route('pedidos') }}" class="nav-link">
                        ...
                        @if ($suporte->count() == 0)
                            <span class="sidebar-text">Pedidos<span
                                    class="badge badge-sm bg-secondary ms-2 text-gray-800"></span>
                            </span>
                        @else
                            <span class="sidebar-text">Pedidos<span
                                    class="badge badge-sm bg-secondary ms-2 text-gray-800">{{ $suporte->count() }}</span>
                            </span>
                        @endif
                    </a>
                </li>
                            ...
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                                ...
                                <div class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                        <span
                                            class="mb-0 font-small fw-bold text-gray-900">{{ session('usuario') }}</span>
                                    </div>
                                </div>
                            </a>
                            ...
                            <table class="table table-striped ">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="border-0">Codigo do usuario</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($suporte as $dado)
                                        <tr>
                                            <td>
                                                <a href="{{ route('finalizar', $dado->id) }}"
