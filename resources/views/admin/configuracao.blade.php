        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item ">
                <a href="{{ route('pedidos') }}" class="nav-link">
                    ...
                    @if ($suporte->count() == 0)
                    <span class="sidebar-text">Pedidos<span class="badge badge-sm bg-secondary ms-2 text-gray-800"></span>
                    </span>
                    @else
                    <span class="sidebar-text">Pedidos<span class="badge badge-sm bg-secondary ms-2 text-gray-800">{{ $suporte->count() }}</span>
                    </span>
                    @endif
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('finalizado') }}">
                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('AdminUsario') }}">
                                <span class="sidebar-text">Cadastrar
                                    Funcionarios</span>
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <h2 class="h5 mb-4">Departamento</h2>
                    <form method="post" action="{{ route('departamento') }}">
                        @csrf
                        <input name="setor" value="" class="form-control  mb-4" placeholder="Departamento">


                        <button type="submit" class=" btn btn-primary mb-4">Registar Departamento</button>
                    </form>
                    ...
                    <table class="table table-centered table-nowrap">
                        ...
                        <tbody>
                            ...
                            <td>{{ $dado->setor }}</td>
                            <td>
                                <button class="btn btn-sm btn-primary" href="{{ $dado->id }}"><i class="fa fa-edit"></i></button>

                                <button class="btn  btn-sm btn-danger" href="{{ $dado->id }}"> <i class="fa fa-trash"></i></button>
            ...
            <div class="col-6">
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <h2 class="h5 mb-4">Nivel de Urgencia</h2>
                    <form method="POST" action="{{ route('nivel') }}">
                        @csrf
                        <input name="nivel" class="form-control mb-4 " placeholder="Urgencia">
                        <button class=" btn btn-primary mb-4"> Registar nivel de Urgencia</button>
                    </form>
                    <table class="table table-centered table-nowrap">
                        <thead>
                            <th>ID</th>
                        ...
                        @foreach ($nivel as $dado )
                        <tbody>
                            <td>{{ $dado->id }}</td>
                            <td>{{ $dado->nivel }}</td>
                            <td>
                                <a class="btn btn-sm btn-primary" href="{{ $dado->id }}"><i class="fa fa-edit"></i></a>
