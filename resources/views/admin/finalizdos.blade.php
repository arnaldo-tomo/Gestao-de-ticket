...
@section('conteudo')
<title>Gestao de ticket - Finalizados</title>
                    ...
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('finalizado') }}">
                                ...
                                <span class="sidebar-text">Finalizadas</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item " aria-current="page"> Ver Pedidos</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Pedidos Pendentes</h1>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped ">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="border-0">FINALIZADO</th>
                                </tr>
                            </thead>

                            <tbody>

                                @foreach ($finalizado as $dado)
                                <tr>
                                    <td> {{ $dado->id }}</td>
                                    <td> {{ $dado->suporte }}</td>
