...
@section('conteudo')
<title>Usuarios de Funcionarios </title>
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Usuarios do sistema</h1>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped ">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="border-0">biografia</th>
                                    <th class="border-0">Verificado</th>
                                    <th class="border-0">Registado Em</th>
                                    <th class="border-0">Actulizado Em</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <i class="btn btn-primary btn-sm"><a class="fa fa-print"></a></i>
                                    </td>
                                    <td>{{ $dado->id }}</td>
                                    <td>{{ $dado->name }}</td>
                                    <td>{{ $dado->email }}</td>
                                    <td>{{ $dado->departamento }}</td>
                                    <td>{{ $dado->biografia }}</td>
                                    <td>{{ $dado->remember_token }}</td>
