                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ asset('') }}]">
                                <span class="sidebar-text"><br>Pedentes</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ asset('') }}]">
        ...
        <div class="py-4">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                ...
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Funcionario</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between w-100 flex-wrap">

                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Usuarios Cadastrados no sistema</h1>

                </div>

                <div>
                    <a data-bs-toggle="modal" data-bs-target="#modal-form" class="btn btn-gray-600 align-items-center reunded-0"><i class="fa fa-user-plus"></i>
                        Cadastrar Usuario
                    </a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a href="{{ route('delete', $dado->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-low-vision"></i></a>
                                        <a href="{{ route('usuarioeditar', $dado->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    </td>
                                    <td> {{ $dado->id }}</td>
                                    <td> {{ $dado->name }}</td>
                                    <td> {{ $dado->email }}</td>
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="name" class="form-control" placeholder="Informe o Nome" autofocus>
                                                </div>
                                            </div>
                                            <!-- End of Form -->
                                            <!-- Form -->
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="email" value="{{ old('email') }}" class="form-control" placeholder="example@ucm.ac.mz" name="email" autofocus required>
                                                </div>
                                            </div>
                                            <!-- End of Form -->
                                            <!-- Form -->
                                            <div class="mb-4">
                                                <label class="my-1 me-2" for="country">Departmento</label>
                                                <select class="form-select" name="departamento" {{ old('departamento') }} aria-label="Default select example">
                                                    <option selected disabled>Selecione..</option>
                                                    @foreach ( $setor as $dado )
                                                    <option value="{{ $dado->setor }}">{{ $dado->setor }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <!-- End of Form -->
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" {{ old('password') }} name="password" class="form-control" placeholder="Palavra-passe" autofocus required>
                                                </div>
                                            </div>
                                            <!-- End of Form -->
                                            <!-- Form -->
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" name="password_confirmation" {{ old('password_confirmation') }} class="form-control" placeholder=" Confirme a Palavra-passe" autofocus required>
                                            ...
                                            <!-- End of Form -->
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-gray-800">Registar
                                                    funcionario</button>
                                            </div>
                                        </form>
